...
class AE(nn.Module):
    def __init__(self):
        ...
        self.relu4 = nn.ReLU()
        self.Linear = nn.Linear(14400, 50)
        self.relu5 = nn.ReLU()
        # Decoder section
        self.revLinear = nn.Linear(50, 14400)
        self.relu6 = nn.ReLU()
...
trained = torch.load("SavedModels/model_epoch75.pt")
trained["Linear.weight"] = torch.rand(50, 14400)
trained["Linear.bias"] = torch.rand(50)
trained["revLinear.weight"] = torch.rand(14400, 50)
trained["revLinear.bias"] = torch.rand(14400)
